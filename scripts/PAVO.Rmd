...
r <- curl("https://raw.githubusercontent.com/butterfliesrcool/Temporal_Synchrony_Predation_Experiments/main/data/pavo_data/Limenitis_Real_HW_Blue.csv")
...
p <- curl("https://raw.githubusercontent.com/butterfliesrcool/Temporal_Synchrony_Predation_Experiments/main/data/pavo_data/Limenitis_Facsimile_HW_Blue.csv")
...
t <- curl("https://raw.githubusercontent.com/butterfliesrcool/Temporal_Synchrony_Predation_Experiments/main/data/pavo_data/Battus_Real_HW_Blue.csv")
...
```{r load facsimile data }
g <- curl("https://raw.githubusercontent.com/butterfliesrcool/Temporal_Synchrony_Predation_Experiments/main/data/pavo_data/Battus_Facsimile_HW_Blue.csv")
...
<!-- ```{r} -->
<!-- b <- curl("https://raw.githubusercontent.com/butterfliesrcool/Temporal_Dynamics/main/Limenitis_Real_FW_Black.csv") -->
...
<!-- ```{r} -->
<!-- s <- curl("https://raw.githubusercontent.com/butterfliesrcool/Temporal_Dynamics/main/Limenitis_Facsimile_FW_Black.csv") -->
...
<!-- ```{r} -->
<!-- # Evan Code  -->
<!-- vis.model2 <- vismodel(rspecdata = limenitis_FW_black.rspec, visual = 'bluetit', illum = 'bluesky', trans = 'bluetit', qcatch = 'fi', bkg = 'green', vonkries = TRUE) -->
<!-- vis.model2 -->
<!-- JND2 <- coldist(vis.model2,noise = 'neural', n = c(0.37, 0.7, 0.99, 1.0))  -->
<!-- JND2 -->
<!-- # Warning: Quantum catch are relative, distances may not be meaningful  -->
