...
---
# PAVO Analyses for Temporal Dynamics Project 
...
```{r}
r <- curl("https://raw.githubusercontent.com/butterfliesrcool/Temporal_Dynamics/main/Limenitis_Real_HW_Blue.csv")
...
```{r}
p <- curl("https://raw.githubusercontent.com/butterfliesrcool/Temporal_Dynamics/main/Limenitis_Facsimile_HW_Blue.csv")
...
```{r}
t <- curl("https://raw.githubusercontent.com/butterfliesrcool/Temporal_Dynamics/main/Battus_Real_HW_Blue.csv")
...
```{r}
g <- curl("https://raw.githubusercontent.com/butterfliesrcool/Temporal_Dynamics/main/Battus_Facsimile_HW_Blue.csv")
