...
battus <- subset(model, species == "battus")
junonia <- subset(model, species == "junonia")
...
These models aim to statistically assess the following questions: 
...
```{r subset treatments }
T4 <- subset(mimic, treatment == "four")
T2 <- subset(mimic, treatment == "two")
T1 <- subset(mimic, treatment == "one")
T0 <- subset(mimic, treatment == "zero")
```
