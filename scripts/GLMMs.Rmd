...
# make transect variable factor 
class(model$transect)
...
summary(mod_battus)
check_singularity(mod_battus) 
Anova(mod_battus, type = "III") # significant effect of experiment day 
...
summary(mod_junonia)
check_singularity(mod_junonia) 
Anova(mod_junonia, type = "III") # experiment day not significant 
```
...
post_hoc1 <- emmeans(mod_battus, pairwise ~ experiment.day, p.adjust = "bonferroni") 
post_hoc1

post_hoc2 <- emmeans(mod_battus, pairwise ~ experiment.day, p.adjust = "scheffe") 
post_hoc2
