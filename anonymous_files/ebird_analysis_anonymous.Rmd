...
attacks_plot
ggsave(attacks_plot, file = ".../attacks_plot.pdf", width=15, height=10, units=c("in"), useDingbats=FALSE)
...
write.csv(moran_table,file='/.../moran_table.csv', row.names=FALSE)
...
ggsave(community_bubble_plot, file = "/.../community_bubble_plot.pdf", width=20, height=10, units=c("in"), useDingbats=FALSE)
```
...
ggsave(community_bubble_plot_effort, file = "/.../community_bubble_plot_effort.pdf", width=25, height=10, units=c("in"), useDingbats=FALSE)
...
for (i in my_species_splits) {
  ...
  ggsave(plot, file=paste0("...", "plot_", unique(i$species), ".pdf"), width = 25, height = 15, units = "cm")
  }
...
dat=map_data("world")
quabbin_shp <- st_read('/.../QRBATH_POLY.shp')
summary(quabbin_shp)
...
ggsave(quab_map2, file = "/.../quab_map2.pdf", width=20, height=10, units=c("in"), useDingbats=FALSE)
...
ggsave(bird_map, file = "/.../bird_map.pdf", width=20, height=10, units=c("in"), useDingbats=FALSE)
...
ggsave(bird_map, file = "/.../bird_map_NE.pdf", width=20, height=10, units=c("in"), useDingbats=FALSE)
...
quab_map_NE
ggsave(quab_map_NE, file = "/.../quab_map_NE.pdf", width=20, height=10, units=c("in"), useDingbats=FALSE)
...
ggsave(map3, file = "/.../quab_map_legend.pdf", width=20, height=10, units=c("in"), useDingbats=FALSE)
